                    ...
                    data.map((task) => (
                        <div key={task.id} className="w-60 h-60 flex justify-evenly items-start p-4 flex-col bg-slate-100 rounded-xl hover:bg-slate-50 hover:shadow-lg hover:shadow-blue-200 hover:-translate-y-1 select-none hover:cursor-pointer duration-300">
                            ...
                            <div className="w-4/5 mt-6 flex justify-start items-center gap-4">
                                <button onClick={() => window.location.href = `http://localhost:3000/show/${task.id}`} className="flex justify-center items-center rounded-xl bg-sky-300 hover:bg-sky-500 duration-100 p-2">
                                ...
                                <button onClick={() => window.location.href = `http://localhost:3000/show/edit/${task.id}`} className="flex justify-center items-center rounded-xl bg-yellow-300 hover:bg-yellow-500 duration-100 p-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="size-6">
